...
G4int DetectionSystem8pi::AddGermanium()
{
  ...
  {
    germanium_block_log = new G4LogicalVolume(germanium_block_with_cavity, material, "germanium_block_log", 0, 0, 0);
...
G4int DetectionSystem8pi::AddInnerBGOAnnulus()
{
  ...
  {
    inner_BGO_annulus_log = new G4LogicalVolume(inner_BGO_annulus, material, "inner_BGO_annulus", 0, 0, 0);
...
G4int DetectionSystem8pi::AddOuterBGOAnnulus()
{
  ...
  {
    outer_lower_BGO_annulus_log = new G4LogicalVolume(outer_lower_BGO_annulus, material, "outer_lower_BGO_annulus", 0, 0, 0);
...
//       false, detector_number);
  ...
  {
    outer_upper_BGO_annulus_log = new G4LogicalVolume(outer_upper_BGO_annulus, material, "outer_upper_BGO_annulus", 0, 0, 0);
