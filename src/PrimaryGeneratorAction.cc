...
void PrimaryGeneratorAction::GeneratePrimaries(G4Event* anEvent)
{
    if(numberOfDecayingLaBrDetectors != 0) {
        ...
        G4ParticleDefinition* effgamma = G4ParticleTable::GetParticleTable()->FindParticle("gamma");
        G4ThreeVector effposition = G4ThreeVector(0.0*mm,0.0*mm,0.0*mm);
        ...
        fParticleGun->SetParticleDefinition(effgamma);
        fParticleGun->SetParticlePosition(effposition);
